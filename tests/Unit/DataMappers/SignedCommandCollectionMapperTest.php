...
final class SignedCommandCollectionMapperTest extends TestCase
{
    ...
    /** @test */
    public function it_should_be_able_to_map_a_signed_command_collection_to_an_array(): void
    {
        $actual = SignedCommandCollectionMapper::toArray(new SignedCommandCollection($this->signedCommand));

        $this->assertEquals(['cmds' => [$this->signedCommandArray]], $actual);
    }

    /** @test */
    public function it_should_be_able_to_map_a_signed_command_collection_to_a_string(): void
    {
        $actual = SignedCommandCollectionMapper::toString(new SignedCommandCollection($this->signedCommand));

        $this->assertEquals(json_encode(['cmds' => [$this->signedCommandArray]], JSON_THROW_ON_ERROR), $actual);
    }
}
